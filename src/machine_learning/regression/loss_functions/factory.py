...
def create_loss_function(config: RegressionLossFunctionConfig) -> Module:
    """
    Create a loss function based on the configuration.

    Args:
        config (RegressionLossFunctionConfig): Configuration object containing loss function parameters.
